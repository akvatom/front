...
<template>
    <div :class="{ 'lg:py-3 lg:px-4 lg:h-10 lg:bg-white lg:hover:bg-[#E5E9F0] lg:active:bg-[#CCD3E1]': props.isButton }"
        class="flex gap-2 items-center rounded-lg cursor-pointer select-none">
        <div class="w-6 h-6 flex justify-center items-center cursor-pointer">
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="20" viewBox="0 0 18 20" fill="none">
                ...
                <path opacity="0.4" fill-rule="evenodd" clip-rule="evenodd"
                    d="M4.05541 14.4929C1.61238 15.0294 0 15.9519 0 17C0 18.6569 4.02944 20 9 20C13.9706 20 18 18.6569 18 17C18 15.9519 16.3876 15.0294 13.9446 14.4929C13.8031 14.6501 13.6601 14.8027 13.5161 14.9502C12.8438 15.6393 12.1214 16.2485 11.4009 16.6959C10.7141 17.1224 9.87298 17.5 9 17.5C8.12701 17.5 7.28586 17.1224 6.59907 16.6959C5.87856 16.2485 5.15617 15.6393 4.48387 14.9502C4.33993 14.8027 4.19692 14.6501 4.05541 14.4929Z"
                    fill="#E82C71" />
            </svg>
        </div>
        <span class="text-sm text-darkBlue max-lg:hidden" v-if="props.isButton">
            <slot></slot>
        </span>
    </div>
</template>