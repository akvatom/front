import { hasInjectionContext, getCurrentInstance, version, ref, watchEffect, watch, inject, toRef, isRef, computed, unref, reactive, defineComponent, h, onUnmounted, useSSRContext, shallowRef, onServerPrefetch, resolveComponent, Fragment, mergeProps, createApp, effectScope, provide, onErrorCaptured, createVNode, resolveDynamicComponent, shallowReactive, isReadonly, Text, defineAsyncComponent, isShallow, isReactive, toRaw, withAsyncContext, withCtx, createTextVNode, nextTick, Suspense, Transition } from 'vue';
import { d as useRuntimeConfig$1, w as withQuery, l as hasProtocol, p as parseURL, m as isScriptProtocol, j as joinURL, h as createError$1, n as hash, o as parse$1, q as getRequestHeader, $ as $fetch, r as sanitizeStatusCode, t as destr, v as isEqual, x as setCookie, y as getCookie, z as deleteCookie, A as parseQuery, B as createHooks, C as withTrailingSlash$1, D as withoutTrailingSlash$1, E as serialize, F as isEqual$1, G as getRequestHeaders, H as defu } from '../nitro/node-server.mjs';
...
import { ssrRenderAttrs, ssrRenderClass, ssrRenderSlot, ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode, ssrRenderAttr } from 'vue/server-renderer';
import 'node:http';
import 'node:https';
import 'fs';
import 'path';
...
const __nuxt_component_11 = /* @__PURE__ */ defineNuxtLink(nuxtLinkDefaults);
...
const _routes = [
  {
    name: "doctor-doctorid___uz",
    path: "/uz/doctor/:doctorid()",
    meta: {},
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/_doctor-id_-02ec3906.mjs').then((m) => m.default || m)
  },
  {
    name: "doctor-doctorid___ru",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-4e48742b.mjs').then((m) => m.default || m)
  },
  {
    name: "index___ru",
    path: "/",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/privacy-8618622a.mjs').then((m) => m.default || m)
  },
  {
    name: "privacy___ru",
    path: "/privacy",
  ...
  {
    name: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.name) ?? "profile___uz",
    path: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.path) ?? "/uz/profile",
    meta: __nuxt_page_meta || {},
    alias: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.alias) || [],
    redirect: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.redirect) || void 0,
    component: () => import('./_nuxt/profile-e8e6c124.mjs').then((m) => m.default || m)
  },
  {
    name: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.name) ?? "profile___ru",
...
const namedMiddleware = {
  auth: () => import('./_nuxt/auth-d92d68d8.mjs')
};
...
const resolveNuxtI18nOptions = async (context) => {
  ...
  await mergeVueI18nConfigs(() => import(
    './_nuxt/i18n.config-27479222.mjs'
...
const clickOutside_C8jIyDRU4O = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
  nuxtApp.vueApp.use(vClickOutside);
});
const google_recaptcha_wBxLdS1eoU = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
...
const layouts = {
  default: () => import('./_nuxt/default-bbb2d9cf.mjs').then((m) => m.default || m)
};
...
const useSelectedSort = () => useState(() => 0, "$vuSkebpfZQ");
const useLoginModal = () => useState(() => false, "$e2S2C1cBHg");
const useClinicModal = () => useState(() => false, "$U5p6uvu2r8");
const useLoginTitle = () => useState(() => "loginTitle.default", "$kmKZllmEkf");
const useRedirect = () => useState(() => null, "$mI3xJm7LU1");
const useToastOpen = () => useState(() => false, "$MFvKPKaXY6");
const useToastText = () => useState(() => null, "$xKhFwZ8wFK");
const useAuthenticated = () => useState(() => false, "$ZKG7eESX1H");
const useGenderOptions = () => useState(() => [
  { name: "userGender[1]", value: "M" },
  { name: "userGender[0]", value: "F" }
], "$P1qT6t69OV");
const useUserInfo = () => useState(() => null, "$Bow2x4xKGL");
const useCount = () => useState(() => 0, "$of3SYNv3LR");
...
const useMyFetch = async (request, opts) => {
...
const useAuthUser = async ({ phone_number, code: code2 }, lang) => {
  const body = {
    phone_number,
    user_entered_code: code2
  };
...
const useRefreshToken = async (lang) => {
  const refresh = useCookie("refresh");
  const token = useCookie("access");
  const isAuthenticated = useAuthenticated();
  const body = {
...
const usePersonalData = async (lang, access) => {
  const userInfo = useUserInfo();
  const isAuthenticated = useAuthenticated();
  const accessToken = useCookie("access");
  if (!accessToken.value && !access)
    return;
  if (!userInfo.value) {
...
const _sfc_main$3 = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "grid grid-rows-[max-content_1fr_max-content] min-h-[100svh]" }, _attrs))}>`);
...
const __nuxt_component_1 = /* @__PURE__ */ defineComponent({
  ...
  setup(props, { slots }) {
    ...
    const resolvedPath = computed(() => props.to != null ? localePath2(props.to, props.locale) : props.to);
    const isExternal = computed(() => {
      if (props.external) {
        return true;
      }
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<button${ssrRenderAttrs(mergeProps({
        class: ["p-4 rounded-lg text-sm leading-normal font-bold flex-center gap-2 h-12 transition-200", {
          "bg-red hover:bg-[#BA2A6F] active:bg-[#BA2A6F] text-white": __props.state == "red",
          "bg-blue hover:bg-[#176BC2] active:bg-[#176BC2] text-white": __props.state == "primary",
          "bg-bg hover:bg-[#DBE3F0] active:bg-[#DBE3F0] text-darkBlue": __props.state == "secondary",
          "!bg-bg !text-[#92A3C3] !font-normal pointer-events-none": __props.isDisabled,
          "opacity-40 pointer-events-none": __props.isLoading
        }]
      }, _attrs))}>`);
      if (__props.isLoading) {
        _push(`<div class="w-6 h-6 flex-center animate-[spin_1.2s_cubic-bezier(0.5,0,0.5,1)_infinite]"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"><path fill-rule="evenodd" clip-rule="evenodd" d="M13 18C13.5304 18 14.0391 18.2107 14.4142 18.5858C14.7893 18.9609 15 19.4696 15 20C15 20.5304 14.7893 21.0391 14.4142 21.4142C14.0391 21.7893 13.5304 22 13 22C12.4696 22 11.9609 21.7893 11.5858 21.4142C11.2107 21.0391 11 20.5304 11 20C11 19.4696 11.2107 18.9609 11.5858 18.5858C11.9609 18.2107 12.4696 18 13 18ZM6.741 15C7.40404 15 8.03993 15.2634 8.50877 15.7322C8.97761 16.2011 9.241 16.837 9.241 17.5C9.241 18.163 8.97761 18.7989 8.50877 19.2678C8.03993 19.7366 7.40404 20 6.741 20C6.07796 20 5.44207 19.7366 4.97323 19.2678C4.50439 18.7989 4.241 18.163 4.241 17.5C4.241 16.837 4.50439 16.2011 4.97323 15.7322C5.44207 15.2634 6.07796 15 6.741 15ZM18.319 15.5C18.8494 15.5 19.3581 15.7107 19.7332 16.0858C20.1083 16.4609 20.319 16.9696 20.319 17.5C20.319 18.0304 20.1083 18.5391 19.7332 18.9142C19.3581 19.2893 18.8494 19.5 18.319 19.5C17.7886 19.5 17.2799 19.2893 16.9048 18.9142C16.5297 18.5391 16.319 18.0304 16.319 17.5C16.319 16.9696 16.5297 16.4609 16.9048 16.0858C17.2799 15.7107 17.7886 15.5 18.319 15.5ZM20.5 11.319C20.8978 11.319 21.2794 11.477 21.5607 11.7583C21.842 12.0396 22 12.4212 22 12.819C22 13.2168 21.842 13.5984 21.5607 13.8797C21.2794 14.161 20.8978 14.319 20.5 14.319C20.1022 14.319 19.7206 14.161 19.4393 13.8797C19.158 13.5984 19 13.2168 19 12.819C19 12.4212 19.158 12.0396 19.4393 11.7583C19.7206 11.477 20.1022 11.319 20.5 11.319ZM4.5 8C5.16304 8 5.79893 8.26339 6.26777 8.73223C6.73661 9.20107 7 9.83696 7 10.5C7 11.163 6.73661 11.7989 6.26777 12.2678C5.79893 12.7366 5.16304 13 4.5 13C3.83696 13 3.20107 12.7366 2.73223 12.2678C2.26339 11.7989 2 11.163 2 10.5C2 9.83696 2.26339 9.20107 2.73223 8.73223C3.20107 8.26339 3.83696 8 4.5 8ZM19.786 7.207C20.0512 7.207 20.3056 7.31236 20.4931 7.49989C20.6806 7.68743 20.786 7.94178 20.786 8.207C20.786 8.47222 20.6806 8.72657 20.4931 8.91411C20.3056 9.10164 20.0512 9.207 19.786 9.207C19.5208 9.207 19.2664 9.10164 19.0789 8.91411C18.8914 8.72657 18.786 8.47222 18.786 8.207C18.786 7.94178 18.8914 7.68743 19.0789 7.49989C19.2664 7.31236 19.5208 7.207 19.786 7.207ZM10 2C10.7956 2 11.5587 2.31607 12.1213 2.87868C12.6839 3.44129 13 4.20435 13 5C13 5.79565 12.6839 6.55871 12.1213 7.12132C11.5587 7.68393 10.7956 8 10 8C9.20435 8 8.44129 7.68393 7.87868 7.12132C7.31607 6.55871 7 5.79565 7 5C7 4.20435 7.31607 3.44129 7.87868 2.87868C8.44129 2.31607 9.20435 2 10 2ZM17.5 5C17.6326 5 17.7598 5.05268 17.8536 5.14645C17.9473 5.24021 18 5.36739 18 5.5C18 5.63261 17.9473 5.75979 17.8536 5.85355C17.7598 5.94732 17.6326 6 17.5 6C17.3674 6 17.2402 5.94732 17.1464 5.85355C17.0527 5.75979 17 5.63261 17 5.5C17 5.36739 17.0527 5.24021 17.1464 5.14645C17.2402 5.05268 17.3674 5 17.5 5Z" fill="white" class="${ssrRenderClass({ "fill-darkBlue": __props.state == "secondary" })}"></path></svg></div>`);
      } else {
        _push(`<!---->`);
      }
...
const _imports_0 = "" + __buildAssetsURL("illustration.7c0a3e60.png");
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(ssrRenderComponent(_component_NuxtLayout, null, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<div class="container mt-8"${_scopeId}><div class="flex-y-center flex-col gap-4 max-w-[492px] mx-auto"${_scopeId}><img width="370" height="385"${ssrRenderAttr("src", _imports_0)} alt="illustaration"${_scopeId}><h1 class="text-2xl md:text-[32px] leading-normal text-darkBlue font-bold text-center"${_scopeId}> Упс! Похоже, вы попали на несуществующую страницу </h1><p class="text-xs md:text-base text-secondary text-center"${_scopeId}> Пожалуйста, перезагрузите приложение или перейдите на главную страницу </p>`);
        _push2(ssrRenderComponent(_component_NuxtLinkLocale, { to: "/" }, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(ssrRenderComponent(_component_BaseButton, { state: "primary" }, {
                default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                  if (_push4) {
                    _push4(`Перейти на главную страницу`);
                  } else {
                    return [
                      createTextVNode("Перейти на главную страницу")
                    ];
                  }
                }),
                _: 1
              ...
              return [
                createVNode(_component_BaseButton, { state: "primary" }, {
                  default: withCtx(() => [
                    createTextVNode("Перейти на главную страницу")
                  ]),
                  _: 1
        ...
        return [
          createVNode("div", { class: "container mt-8" }, [
            createVNode("div", { class: "flex-y-center flex-col gap-4 max-w-[492px] mx-auto" }, [
              createVNode("img", {
                width: "370",
                height: "385",
                src: _imports_0,
              ...
              createVNode("h1", { class: "text-2xl md:text-[32px] leading-normal text-darkBlue font-bold text-center" }, " Упс! Похоже, вы попали на несуществующую страницу "),
              createVNode("p", { class: "text-xs md:text-base text-secondary text-center" }, " Пожалуйста, перезагрузите приложение или перейдите на главную страницу "),
              createVNode(_component_NuxtLinkLocale, { to: "/" }, {
                default: withCtx(() => [
                  createVNode(_component_BaseButton, { state: "primary" }, {
                    default: withCtx(() => [
                      createTextVNode("Перейти на главную страницу")
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/island-renderer-024f7ff6.mjs').then((r) => r.default || r));
    const nuxtApp = /* @__PURE__ */ useNuxtApp();
...
export { useGenderOptions as A, useLogOut as B, defineNuxtRouteMiddleware as C, executeAsync as D, useNuxtApp as E, useRouter as F, globalMiddleware as G, useSwitchLocalePath as H, useClinicModal as I, useHead as J, useAuthUser as K, _export_sfc as _, useState as a, __nuxt_component_2 as b, createError as c, useAuthenticated as d, entry$1 as default, useLoginTitle as e, useLoginModal as f, useRedirect as g, useCookie as h, useMyFetch as i, useRoute as j, useSeoMeta as k, useUserInfo as l, usePersonalData as m, useSort as n, useSelectedSort as o, useFilters as p, __nuxt_component_1 as q, __nuxt_component_11 as r, useFetch as s, useRuntimeConfig as t, useI18n as u, navigateTo as v, useCount as w, useLocalePath as x, useToastOpen as y, useToastText as z };
