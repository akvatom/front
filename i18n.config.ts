  ...
  messages: {
    uz: {
      ...
      banner: {
        ...
        description:
          "Ideal shifokoringizni toping - hoziroq qabuliga yoziling!",
      ...
      privacy: {
        ...
        description:
          "Ushbu maxfiylik siyosati klinika qabullariga yozilish uchun mobil ilovamizdan va veb-saytimizdan foydalanganingizda shaxsiy maʼlumotlaringizni qanday yig‘ishimiz, foydalanishimiz va oshkor qilishimizni tavsiflaydi.",
        list: [
          {
            title: "Ma'lumot to'plash va ulardan foydalanish",
            description:
              "Shifokor qabuliga yozilish uchun ilovamizdan foydalanganingizda, ismingiz, elektron pochta manzilingiz, telefon raqamingiz va uchrashuvni rejalashtirish maʼlumotlari kabi baʼzi shaxsiy maʼlumotlarni toʻplashimiz mumkin. Bu maʼlumotlardan faqat uchrashuvlarni rejalashtirish xizmati va tegishli funksiyalarni taqdim etish uchun foydalaniladi.",
          },
          {
            title: "Axborotni oshkor qilish",
            description:
              "Biz sizning shaxsiy ma'lumotlaringizni sizning roziligingizsiz tomonlar bilan baham ko'rmaymiz, xizmat ko'rsatish, qonunlarga rioya qilish yoki uchinchi huquqlarimizni himoya qilish talab qilinadigan hollar bundan mustasno.",
          },
          {
            title: "Xavfsizlik",
            description:
              "Biz sizning shaxsiy ma'lumotlaringizni ruxsatsiz kirish, o'zgartirish yoki yo'q qilishdan himoya qilish uchun barcha zarur choralarni ko'ramiz.",
          },
        ],
      },
      ...
      phoneInfo:
        "Uchrashuvni tasdiqlash va ma’lumot berish uchun ushbu raqamga qo‘ng‘iroq qilamiz.",
      booking: "Qabulga yozilish",
      bookSuccess: "Arizangiz uchun rahmat!",
      bookSuccessInfo:
        "Shifokor qabuliga yozilish uchun arizangiz muvaffaqiyatli qabul qilindi. Mutaxassislarimiz tez orada siz bilan bog'lanib, uchrashuvingizni tasdiqlaydi va ma'lumot beradi.",
      nice: "Tushunarli",
      bookError: "Xatolik yuz berdi",
      bookErrorInfo:
        "Kechirasiz, soʻrovingizni koʻrib chiqishda xatolik yuz berdi. Keyinroq qayta urinib ko‘ring yoki qo‘shimcha yordam olish uchun qo‘llab-quvvatlash xizmatimizga murojaat qiling.",
    ...
    ru: {
      ...
      banner: {
        ...
        description:
          "Найдите своего идеального врача - Запишитесь на прием прямо сейчас!",
      ...
      privacy: {
        ...
        description:
          "Эта политика конфиденциальности описывает, как мы собираем, используем и раскрываем вашу личную информацию при использовании нашего мобильного приложения для записи на клинику.",
        list: [
          {
            title: "Сбор и использование информации",
            description:
              "Мы можем собирать определенную личную информацию, когда вы используете наше приложение для записи на клинику, такую как ваше имя, адрес электронной почты, номер телефона и информация о записях на приемы. Эта информация используется исключительно для целей предоставления услуги записи на приемы и связанных функций.",
          },
          {
            title: "Раскрытие информации",
            description:
              "Мы не будем делиться вашей личной информацией с третьими сторонами без вашего согласия, за исключением случаев, когда это необходимо для предоставления услуги, соблюдения закона или защиты наших прав.",
          },
          {
            title: "Безопасность",
            description:
              "Мы принимаем все необходимые меры для защиты вашей личной информации от несанкционированного доступа, изменения или уничтожения.",
          },
        ],
      },
      ...
      phoneInfo:
        "Мы будем звонить на этот номер для подтверждения записи и предоставления информации",
      booking: "Записаться",
      bookSuccess: "Спасибо за вашу заявку!",
      bookSuccessInfo:
        "Ваша заявка на запись к врачу успешно принята. Наша команда специалистов скоро свяжется с вами для подтверждения записи и предоставления информации",
      nice: "Хорошо",
      bookError: "Произошла ошибка",
      bookErrorInfo:
        "Извините, произошла ошибка при обработке вашей заявки на запись к врачу. Пожалуйста, попробуйте еще раз позже, или свяжитесь с нашей службой поддержки для получения дополнительной помощи.",
      retry: "Повторить",
