import { _ as _imports_2$1, a as __unimport_usePrettyDistance, b as _imports_0, c as __nuxt_component_1$1, d as __nuxt_component_1$2 } from "./clock-8f2938ae.js";
import { _ as __nuxt_component_3 } from "./Location-b1480ac0.js";
import { _ as _export_sfc, u as useI18n, a as useState, b as __nuxt_component_2, d as useAuthenticated, e as useLoginTitle, f as useLoginModal, g as useRedirect, h as useCookie, i as useMyFetch, j as useRoute, k as useSeoMeta, l as useUserInfo, m as usePersonalData } from "../server.mjs";
import { ref, computed, mergeProps, unref, withCtx, createTextVNode, toDisplayString, useSSRContext, watch, createVNode, openBlock, createBlock, withModifiers, Fragment, renderList, withDirectives, isRef, vModelText, withAsyncContext, createCommentVNode } from "vue";
import "hookable";
import "destr";
import "devalue";
import "defu";
import "klona";
import { n as numberWithSpaces, _ as __nuxt_component_0$1 } from "./Modal-c91268d9.js";
import { ssrRenderAttrs, ssrRenderAttr, ssrInterpolate, ssrRenderList, ssrRenderComponent, ssrRenderStyle, ssrRenderClass } from "vue/server-renderer";
import { _ as _imports_0$1 } from "./info-e89625e7.js";
import { _ as _imports_5$1, a as __nuxt_component_1$3 } from "./close-98a6d81e.js";
import { _ as _imports_0$2, a as _imports_1$1 } from "./submitted-error-36cd3fa9.js";
...
import "ohash";
import "@vueuse/core";
const Detail_vue_vue_type_style_index_0_scoped_1de92188_lang = "";
const _sfc_main$3 = {
  __name: "Detail",
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_BaseDatePicker = __nuxt_component_1$2;
      ...
      if (unref(schedule).length) {
        _push(`<div class="flex flex-col gap-4" data-v-1de92188><div class="flex-y-center gap-1" data-v-1de92188><img${ssrRenderAttr("src", _imports_0)} alt="clock" data-v-1de92188><p class="text-xs text-secondary leading-normal" data-v-1de92188>${ssrInterpolate(_ctx.$t("dateTime"))}: </p></div><div class="flex gap-2 z-0" data-v-1de92188>`);
        ...
        _push(`<div class="flex flex-col gap-4" data-v-1de92188><div class="flex-y-center gap-1" data-v-1de92188><img${ssrRenderAttr("src", _imports_0)} alt="clock" data-v-1de92188><p class="text-xs text-secondary leading-normal" data-v-1de92188>${ssrInterpolate(_ctx.$t("submitApplication[0]"))}</p></div>`);
        _push(ssrRenderComponent(_component_BaseButton, {
          state: "primary",
...
const _imports_1 = "" + __buildAssetsURL("star_full.ac82dffd.svg");
const _imports_2 = "" + __buildAssetsURL("chatting.662bc76d.svg");
const _imports_3 = "" + __buildAssetsURL("user-avatar.5ce96821.svg");
const _imports_4 = "" + __buildAssetsURL("user-avatar-female.ce007b8f.svg");
const _imports_5 = "" + __buildAssetsURL("star_empty.9af7600d.svg");
const _sfc_main$2 = {
  __name: "Comments",
  __ssrInlineRender: true,
  props: ["doctor"],
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_BaseButton = __nuxt_component_2;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "bg-white rounded-2xl p-4 flex flex-col gap-4 lg:w-[calc(2/3*100%-10px)]" }, _attrs))}><div class="flex-y-center gap-1"><p class="text-lg text-darkBlue font-bold leading-normal">${ssrInterpolate(_ctx.$t("comments"))}</p><img${ssrRenderAttr("src", _imports_0$1)} alt="information"></div><div class="flex gap-4"><div class="flex flex-col gap-1"><p class="text-xs text-secondary leading-normal">${ssrInterpolate(_ctx.$t("overallRating"))}:</p><div class="flex-y-center gap-1"><img${ssrRenderAttr("src", _imports_1)} alt="Average rating"><p class="text-darkBlue font-bold text-2xl leading-normal">${ssrInterpolate(__props.doctor.average_rating.toFixed(1))}</p></div></div><div class="bg-dividers w-[1px]"></div><div class="flex flex-col gap-1"><p class="text-xs text-secondary leading-normal">${ssrInterpolate(_ctx.$t("numberRating"))}:</p><div class="flex-y-center gap-1"><img${ssrRenderAttr("src", _imports_2)} alt="Number of ratings"><p class="text-darkBlue font-bold text-2xl leading-normal">${ssrInterpolate(__props.doctor.count_of_ratings)}</p></div></div></div>`);
      _push(ssrRenderComponent(_component_BaseButton, {
        class: "font-normal",
        state: "secondary",
              ...
              if (_push2) {
                ...
                if (!unref(isSubmitted)) {
                  ...
                  if (!unref(isSubmittedError)) {
                    _push2(`<img width="96" height="96"${ssrRenderAttr("src", _imports_0$2)} alt="submitted"${_scopeId}>`);
                  } else {
...
const _doctorId__vue_vue_type_style_index_0_scoped_5e62abda_lang = "";
const _sfc_main = {
  __name: "[doctor-id]",
  __ssrInlineRender: true,
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_PageModal = __nuxt_component_0$1;
      const _component_IconRating = __nuxt_component_1$1;
      const _component_BaseInput = __nuxt_component_1$3;
      const _component_BaseButton = __nuxt_component_2;
      const _component_BaseDatePicker = __nuxt_component_1$2;
            ...
            body: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                ...
                if (!unref(isDatePicker) && !unref(isSubmitted)) {
                  ...
                  _push2(`<div class="flex flex-col gap-2" data-v-5e62abda${_scopeId}><div class="bg-bg rounded-lg px-4 py-2 h-12 flex flex-col gap-0.5 cursor-default" data-v-5e62abda${_scopeId}><p class="text-xs text-secondary leading-normal" data-v-5e62abda${_scopeId}>${ssrInterpolate(_ctx.$t("phoneToConfirm"))}</p><p class="text-sm text-darkBlue leading-normal" data-v-5e62abda${_scopeId}>${ssrInterpolate(("numberWithSpaces" in _ctx ? _ctx.numberWithSpaces : unref(numberWithSpaces))(`+998${unref(phone_number)}`, false))}</p></div><div class="flex-y-center gap-2" data-v-5e62abda${_scopeId}><img${ssrRenderAttr("src", _imports_0$1)} alt="info" data-v-5e62abda${_scopeId}><p class="text-xs text-secondary" data-v-5e62abda${_scopeId}>${ssrInterpolate(_ctx.$t("phoneInfo"))}</p></div></div></div>`);
                  _push2(ssrRenderComponent(_component_BaseButton, {
                    onClick: bookDate,
                    state: "primary",
                    type: "submit",
...
export {
  _doctorId_ as default
};
//# sourceMappingURL=_doctor-id_-02ec3906.js.map
