import { effectScope, reactive, hasInjectionContext, getCurrentInstance, version, unref, inject, ref, watchEffect, watch, toRef, shallowRef, onServerPrefetch, isRef, computed, defineComponent, h, resolveComponent, nextTick, shallowReactive, isReadonly, isShallow, isReactive, toRaw, onUnmounted, Fragment, createVNode, Text, Suspense, mergeProps, Transition, provide, withAsyncContext, withCtx, useSSRContext, createTextVNode, onErrorCaptured, resolveDynamicComponent, defineAsyncComponent, createApp } from "vue";
...
import { withQuery, hasProtocol, parseURL, isScriptProtocol, joinURL, parseQuery, withTrailingSlash as withTrailingSlash$1, withoutTrailingSlash as withoutTrailingSlash$1, isEqual as isEqual$1 } from "ufo";
...
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderClass, ssrRenderSlot, ssrRenderAttr, ssrRenderSuspense, ssrRenderVNode } from "vue/server-renderer";
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/_doctor-id_-02ec3906.js").then((m) => m.default || m)
  },
  {
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-4e48742b.js").then((m) => m.default || m)
  },
  {
    name: "index___ru",
    path: "/",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/privacy-8618622a.js").then((m) => m.default || m)
  },
  {
    name: "privacy___ru",
    path: "/privacy",
  ...
  },
  {
    ...
    component: () => import("./_nuxt/profile-e8e6c124.js").then((m) => m.default || m)
  },
  {
...
const namedMiddleware = {
  auth: () => import("./_nuxt/auth-d92d68d8.js")
};
...
const layouts = {
  default: () => import("./_nuxt/default-bbb2d9cf.js").then((m) => m.default || m)
};
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/island-renderer-024f7ff6.js").then((r) => r.default || r));
    const nuxtApp = /* @__PURE__ */ useNuxtApp();
...
export {
  useGenderOptions as A,
  useLogOut as B,
  defineNuxtRouteMiddleware as C,
  executeAsync as D,
  useNuxtApp as E,
  useRouter as F,
  globalMiddleware as G,
  useSwitchLocalePath as H,
  useClinicModal as I,
  useHead as J,
  useAuthUser as K,
  _export_sfc as _,
  ...
  useSeoMeta as k,
  useUserInfo as l,
  usePersonalData as m,
  useSort as n,
  useSelectedSort as o,
  useFilters as p,
  __nuxt_component_1 as q,
  __nuxt_component_11 as r,
  useFetch as s,
